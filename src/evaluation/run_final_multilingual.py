...
def main() -> None:
    ...
    for record in records:
        ...
        follow={"B0":prompt_cfg["B0"],"B1":prompt_cfg["B1"],"B2":prompt_cfg["B2_template"].replace("{suggestion_text}", opts[record["wrong_suggestion_option"]]),"B3":prompt_cfg["B3_template"].replace("{suggestion_text}", opts[record["correct_option"]])}
