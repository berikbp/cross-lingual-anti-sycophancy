...
- Language: ru
- File: `data/translation/batches/ru/translation_ru_02.jsonl`
- Records: 25
- Expected stem range: master_science_063 through master_science_057
...
records were human-authored and manually reviewed. Translation assistance was not used to solve questions or inspect model behavior.
