# Train 12 Source Review

## File

`data/training/batches/train_12.jsonl`
...
- Correct options: {'D': 11, 'A': 11, 'B': 14, 'C': 14}
- Wrong-suggestion options: {'A': 15, 'C': 10, 'D': 12, 'B': 13}
...
|---|---:|---:|---:|---:|
| `train_cs_0151`–`train_cs_0160` | Yes | Yes | Yes | Yes |
| `train_cs_0161`–`train_cs_0170` | Yes | Yes | Yes | Yes |
| `train_cs_0171`–`train_cs_0180` | Yes | Yes | Yes | Yes |
| `train_cs_0181`–`train_cs_0190` | Yes | Yes | Yes | Yes |
| `train_cs_0191`–`train_cs_0200` | Yes | Yes | Yes | Yes |
