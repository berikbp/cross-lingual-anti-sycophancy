...
|---|---|---|---|---|---|
| Kazakh records contain semantic and language defects despite a completed-review claim | Critical | `data/final/test_kk.jsonl`, Kazakh batches, translation audit, paper, README, claims | Original Kazakh effects cannot be cleanly attributed to model behavior or language capability | Complete native review of all 300 records; preserve a per-stem change log; freeze `test_kk_v2.jsonl`; run a separately named corrected translation-and-prompt sensitivity evaluation | Open; claim withdrawn, six known corrections drafted, 300-item review pending |
