...
No three-language macro-average is reported because the locked Kazakh condition is translation-confounded. The completed corrected Kazakh sensitivity run is reported separately in `reports/corrected_kazakh_v2_analysis.md` and does not replace these Stage 20 results.
