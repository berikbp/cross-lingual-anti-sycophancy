...
- `paper/`: technical report, tables, and figures
...
from Git but published with the `v1.1.3` release:

- [raw generations](https://github.com/berikbp/cross-lingual-anti-sycophancy/releases/download/v1.1.3/cross-lingual-anti-sycophancy-1.1.3-raw-results.tar.gz)
- [Control-v2 and Selective-v2 adapters](https://github.com/berikbp/cross-lingual-anti-sycophancy/releases/download/v1.1.3/cross-lingual-anti-sycophancy-1.1.3-adapters.tar.gz)
- [source and result checksums](https://github.com/berikbp/cross-lingual-anti-sycophancy/releases/download/v1.1.3/SOURCE_AND_RESULTS_SHA256SUMS.txt)
- [adapter checksum](https://github.com/berikbp/cross-lingual-anti-sycophancy/releases/download/v1.1.3/ADAPTER_SHA256SUMS.txt)
